...
func TestEventRepository_ListEvents(t *testing.T) {
	t.Run("given open and closed events when filter nil then returns all", func(t *testing.T) {
	...
	t.Run("given open and closed when filter true then only open", func(t *testing.T) {
		db := testutil.OpenSQLite(t)
	...
	t.Run("given open and closed when filter false then only closed", func(t *testing.T) {
		db := testutil.OpenSQLite(t)
